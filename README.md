...
>
> Được tổng hợp từ việc phân tích `index.android.js` (dịch ngược 'index.android.bundle' trích xuất từ 'base.apk'). Chỉ sử dụng cho mục đích học tập và nghiên cứu — không chứa logic gen mã điểm danh hay bất kỳ nội dung nào hỗ trợ gian lận điểm danh.
...
## 1. Định dạng mã QR
<img width="331" height="340" alt="image" src="https://github.com/user-attachments/assets/f70f7482-f2fe-438c-85b8-c4c71a148503" />
