...
## 1. Định dạng mã QR
<img width="698" height="547" alt="image" src="https://github.com/user-attachments/assets/b19b8514-86b2-439e-9a60-c334a7c3133b" />
...
- Cách server sinh `maDiemDanh` hay chu kỳ/thuật toán sinh mã QR (logic này nằm ở server, không có trong client bundle).
